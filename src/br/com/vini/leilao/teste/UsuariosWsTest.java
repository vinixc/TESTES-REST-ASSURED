...
public class UsuariosWsTest {
	...
	public void setUp() {
		...
		// Esse é o padrao de URI e PORT - Caso o Serviço esteja em outro lugar
		// configurar nessas variaveis.
	...
	public void deveRetornarListaDeUsuario() {
		XmlPath xmlPath = given().header("Accept", "application/xml").get("/usuarios").andReturn().xmlPath();
